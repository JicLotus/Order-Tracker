...
public abstract class SupplementalInfoRetriever extends AsyncTask<Object,Object,Object> {
  ...
  @SuppressLint("NewApi") public static void maybeInvokeRetrieval(TextView textView,
                                          ParsedResult result,
  ...
  @SuppressLint("NewApi") static void maybeAddText(String text, Collection<String> texts) {
