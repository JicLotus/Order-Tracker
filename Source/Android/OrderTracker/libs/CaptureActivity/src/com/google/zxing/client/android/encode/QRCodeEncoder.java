...
final class QRCodeEncoder {
  ...
  @SuppressLint("NewApi") private void encodeFromTextExtras(Intent intent) throws WriterException {
  ...
  @SuppressLint("NewApi") private void encodeFromStreamExtra(Intent intent) throws WriterException {
    format = BarcodeFormat.QR_CODE;
  ...
  @SuppressLint("NewApi") private void encodeQRCodeContents(Intent intent, String type) {
  ...
  @SuppressLint("NewApi") private void encodeQRCodeContents(AddressBookParsedResult contact) {
    ContactEncoder encoder = useVCard ? new VCardContactEncoder() : new MECARDContactEncoder();
