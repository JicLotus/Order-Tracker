...
class NuevoDescuentoController extends Controller
{
    ...
    public function guardar(Request $request)
    {
		...
		if ($idCategoria!=0){
			...
			$sql = "Insert into notificaciones (id_usuario, tipo_notificacion, porcentaje, valor, desde, hasta)
					select usuarios.id, $tipo , $porcentaje, categorias.nombre, $desde, $hasta from usuarios, categorias
		...
		if ($idMarca!=0){
			...
			$sql = "Insert into notificaciones (id_usuario, tipo_notificacion, porcentaje, valor, desde, hasta)
					select usuarios.id, $tipo , $porcentaje, marcas.nombre, $desde, $hasta from usuarios, marcas
		...
		if ($cantidad!=0){
			...
			$sql = "Insert into notificaciones (id_usuario, tipo_notificacion, porcentaje, valor, desde, hasta)
					select id, $tipo , $porcentaje, $cantidad, $desde, $hasta from usuarios";
			DB::insert($sql);
